...
SettingsDialog::SettingsDialog(
    QSettings *a_settings_ptr,
    const QList<ConstructControlBlock> &a_cntrBlckList, QWidget *parent)
    : QDialog(parent), ui(new Ui::SettingsDialog),
      m_constants(Constants::getInstance()), m_settings_ptr(a_settings_ptr) {
  ui->setupUi(this);

  m_mathlogic_qptr =
      new MathLogic(m_settings_ptr->value(m_constants.mintemp_name).toInt(),
