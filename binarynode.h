...
class BinaryNode
{
  public:
    ...
    BinaryNode(const BinaryNode &anode)
        : m_name(anode.m_name), m_val(anode.m_val), m_left(anode.m_left), m_right(anode.m_right)
    {
    }
    ...
    void
    setLeftNode(QSharedPointer<BinaryNode> a_node)
    {
        m_left = a_node;
    }

    QSharedPointer<BinaryNode>
    getLeft()
    {
        return m_left;
    }
    ...
    void
    setRightNode(QSharedPointer<BinaryNode> a_node)
    {
        m_right = a_node;
    }
    ...
    void
    addBinaryNode(QSharedPointer<BinaryNode> a_right)
    {
        m_right = a_right;
    }
